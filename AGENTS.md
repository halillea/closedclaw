...
3. Read `SESSION-STATE.md` — active task context (hot memory)
4. Read `RECENT_CONTEXT.md` — auto-updated highlights
...
**When user asks about past discussions/decisions:**
1. Run: `python3 skills/memory/scripts/recall.py "user's question"`
2. Read the results (they're now in your context)
3. Respond using that context
